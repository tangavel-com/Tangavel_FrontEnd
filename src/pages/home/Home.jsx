...
function Home() {
  return (
    <div className="grid gap-[50px]">
      ...
      <div className="grid gap-[50px] sm:grid-cols-2 sm:gap-[100px] items-center justify-between">
        <div className="grid gap-[20px]">
          <p>முருகன் துணை. யாம் இருக்க பயம் ஏன்.</p>
          <h1 className="text-4xl">Export and Import Company</h1>
          <p>
            We specialize in sourcing high-quality products, managing logistics
            with precision, and ensuring reliable, on-time delivery. With a
            global reach and a commitment to excellence, we're your trusted
            partner in every shipment.
          </p>
      ...
      <div className="sm:flex gap-[50px]">
        ...
        <div className="px-[50px] py-[20px] bg-[#000] text-[#fff] w-full border border-[#fff] rounded-[10px] flex flex-col gap-[20px]">
          <h1 className="xl:hidden text-4xl">Commodity Export</h1>
          <p className="hidden sm:block">
            We export wide range of products to consumers around the world. All
            varieties including raw, powdered, processed, ready to cook, ready
            to eat, decors, cloths, textiles, apparels and so on. Some of the
          ...
          <div>
            <Link
              to="/products/#"
              className="block border rounded-[10px] p-[15px] text-center hover:cursor-pointer hover:scale-102"
            >
              List of products
            </Link>
          </div>
      ...
      <div className="flex gap-[20px] items-center">
        <img
          className="max-w-[100px] "
          src="/icons/Sailing_ship_icon.png"
