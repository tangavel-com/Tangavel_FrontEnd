      ...
      <div className="flex items-center gap-[20px]">
        ...
        <div className="sm:hidden ml-auto">
          <img
            ...
            alt="Menu icon."
            className="max-w-[50px] active:scale-95 transition transform duration-100 "
          />
        </div>
      </div>
      <div
        id="headerLinks"
        className={`${headerLinksVisibility ? 'hidden' : 'block'} sm:block`}
      >
        <ul className="flex flex-col sm:flex-row gap-[50px] items-center">
          ...
          <li>
            <Link onClick={handleMenu} to="/products">
              Products
            </Link>
          </li>
          {/* <li>
